...
for cell_index in cells:
    # Load input
    mat_contents = sio.loadmat('../../data_input/multi_cell/dataset_maxmin.mat')

    # row numbers input set size columns number training set size
    Input = mat_contents['Input_tr_dB_normalized']
    #output
    Output = mat_contents['Output_tr_MR_maxmin_dB_normalized_cell_' + str(cell_index)]
    ...
    model.save('saved_neural_networks/NN_MMMSE_maxmin_cell_'+ str(cell_index) +'.h5')
